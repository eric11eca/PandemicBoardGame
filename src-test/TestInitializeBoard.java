...
public class TestInitializeBoard {
	...
	@Test
	public void testInitializeDiseaseCube1() {
	...
	@Test
	public void testInitializeDiseaseCube2() {
		initializeBoard.board.validInfectionCard.add("a");
		initializeBoard.board.validInfectionCard.add("b");
		initializeBoard.board.validInfectionCard.add("c");
		initializeBoard.board.validInfectionCard.add("d");
	...
	@Test
	public void testInitializeDiseaseCube3() {
		initializeBoard.board.validInfectionCard.add("a");
		initializeBoard.board.validInfectionCard.add("b");
		initializeBoard.board.validInfectionCard.add("c");
		initializeBoard.board.validInfectionCard.add("d");
	...
	@Test
	public void testInitializeEpiDemicCard4() {
		ThreadLocalRandom random = EasyMock.mock(ThreadLocalRandom.class);
