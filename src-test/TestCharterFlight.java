...
public class TestCharterFlight {
	...
	public void setup() {
		...
		player.hand.add(locationCityCard);
		player.hand.add(notLocationCityCard);
	...
	public void testSuccessCharterFlight() {
		...
		mockRandom.action = 4;
		mockRandom.hand.add(locationCityCard);
		mockRandom.hand.add(notLocationCityCard);
		mockRandom.hand.add(eventCard);
